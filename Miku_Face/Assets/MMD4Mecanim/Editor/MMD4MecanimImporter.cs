...
public partial class MMD4MecanimImporter : ScriptableObject
{
	...
	public void OnInspectorGUI()
	{
		...
		if( this.pmx2fbxConfig != null ) {
			if( _licenseAgree == LicenseAgree.NotProcess ) {
				_licenseAgree = CheckLicenseAgree( ref _readmeFiles, ref _readmeTexts, ref _isPiapro, ref _isKancolle );
	...
	public LicenseAgree CheckLicenseAgree( ref string[] readmeFiles, ref string[] readmeTexts, ref bool isPiapro, ref bool isKancolle )
	{
		readmeFiles = FindReadmeFiles();
		readmeTexts = null;
		return CheckLicenseAgree( readmeFiles, ref readmeTexts, ref isPiapro, ref isKancolle );
	}
	...
	public static LicenseAgree CheckLicenseAgree( string[] readmeFiles, ref string[] readmeTexts, ref bool isPiapro, ref bool isKancolle )
	{
		isPiapro = false;
		isKancolle = false;
