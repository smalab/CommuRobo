...
public class TextChange : MonoBehaviour {
	...
	void Update () {
		...
		if (PostureStatus.postureString == "Zenten") {
			this.GetComponent<Text> ().text = "Zenten site masu";
		}
		if (PostureStatus.postureString == "Backten") {
			this.GetComponent<Text> ().text = "Backten yade";
		}
